...
public class SqLiteAccessRequest extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        String strSql4 = "INSERT INTO categorie(categorie) VALUES('Mobiles')";
        String strSql5 = "INSERT INTO categorie(categorie) VALUES('Food')";
        String strSql7 = "INSERT INTO categorie(categorie) VALUES('Boisson')";
        String strSql8 = "INSERT INTO categorie(categorie) VALUES('Ordinateurs')";
        ...
        try{
            ...
            db.execSQL(strSql7);
            db.execSQL(strSql8);
            Log.d("Ajout", "Les categories sont ajoutes avec succes");
        }catch (Exception e){
            Log.d("Ajout", "Echec");
        }
